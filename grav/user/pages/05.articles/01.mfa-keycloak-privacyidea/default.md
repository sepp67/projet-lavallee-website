...
<figure class="prose-figure">
  <img src="/articles/mfa-keycloak-privacyidea/add-MFA-fr.png" alt="Intégrer l'authentification à deux facteurs sans perturber ce qui fonctionne déjà.">
</figure>
...
Le MFA n'est jamais un projet isolé. C'est toujours la première brique d'un projet d'infrastructure d'identité.
...
C'est exactement le type d'architecture que je sais concevoir et mettre en place : partir d'un système existant, sans le casser, et construire dessus une couche d'identité capable d'absorber les besoins de sécurité des années à venir.
